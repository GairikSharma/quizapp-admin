  ...
  return (
    <>
      ...
      <div className="form-wrapper w-full h-screen flex flex-row justify-center items-center">
        <div className="border border-solid border-gray-200 shadow-xl m-5 home-left-section w-full md:w-[80%] lg:w-[75%] h-full md:h-[80%] lg:h-[80%] md:rounded-lg lg:rounded-xl p-10 overflow-y-scroll">
          {isVisible && (
          ...
          <div className="form-content flex flex-col md:flex-row lg:flex-row gap-5 justify-center items-start">
            

            <div className="w-full md:w-full lg:w-[60%] h-full">
            ...
            <div className="w-full md:w-full lg:w-[50%] h-full">
              <div className="question">
                <label className="block text-sm font-medium text-gray-900 my-2">
                  Explaination
                </label>
              ...
              <div className="relative">
                ...
                <select
                  className="block w-[100%] pl-3 px-2 py-2 border border-gray-300 focus:ring-indigo-500 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-opacity-50 rounded-md appearance-none"
              ...
              <button
                className="transition-all w-[30%] mt-2 text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500"
